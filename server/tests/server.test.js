...
describe('DELETE /todos/:id', (done) => {
  ...
  it('Should NOT delete a todo we didnt create', (done) => {
    // grab ID of second stub json object
...
describe('POST /users', () => {
  ...
  it('should create a user', (done) => {
    ...
    var password = '123mnb!';
    // v1.0 NOTE this is the first pass, the second pass we query the db
    //after the uer is created to ensure the passweord was hashed etc
    // request(app)
    // .post('/users')
    // .send({email,password})
    // .expect(200)
